...
public class CategoryReg extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (name.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please Enter Category name", "Warning", JOptionPane.INFORMATION_MESSAGE);
        } else {
            ...
            try {
                ...
                if (rs.next()) {
                    JOptionPane.showMessageDialog(this, "Category Already Exists", "Warning", JOptionPane.INFORMATION_MESSAGE);
                } else {
...
public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CategoryReg.class  
